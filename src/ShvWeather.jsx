...
export function ShvWeather({ device = typeof navigator === "undefined" ? {} : navigator } = {}) {
  ...
  return <section className="shv-weather" aria-labelledby="shv-heading">
    <div><p className="eyebrow">Flugwetter beim Verband</p><h3 id="shv-heading">SHV Meteo</h3><p>Gleitschirmprognosen, Höhenwind, Radar und Prévutemps in der offiziellen SHV-App.</p></div>
