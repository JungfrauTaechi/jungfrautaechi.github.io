...
export const utilityLinks = [{ label: "Wind, Meteo & Webcams", to: routes.meteo.path }, { label: "Sicherheit", to: routes.safety.path, className: "safety-link" }, { label: "DABS", href: "https://www.skybriefing.com/de/" }];
