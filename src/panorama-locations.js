...
const webcamLocations = { 'first-feratel': 'first' };
...
export function groupPanoramaMarkers(links, markers) {
  ...
  for (const marker of markers) {
    const locationId = marker.kind === 'webcam' ? webcamLocations[marker.camera.id] || marker.camera.id : windLocations[marker.station.id] || marker.station.id;
